...
<main>
    ...
    <div class="form-wrapper">
        <form action="/criarNotificacaoComentario" method="POST" class="styled-form">
            @csrf <!-- Token de segurança do Laravel -->

            <div class="form-group">
                <label for="idComentarios">ID Comentário</label>
                <input type="text" id="idComentarios" name="idComentarios" required>
            </div>

            <div class="form-group button-wrapper">
                <button type="submit" class="submit-btn">Criar Notificação</button>
            </div>
        </form>
    </div>
</main>
...
<style>
    ...
    .styled-form {
        background-color: #1f2b5b; /* Azul escuro do cliente */
        padding: 20px;
        border-radius: 8px;
    ...
    .form-group label {
        ...
        font-weight: 600;
        margin-bottom: 6px;
        color: #eaf4f4; /* Azul claro para o texto */
    }
