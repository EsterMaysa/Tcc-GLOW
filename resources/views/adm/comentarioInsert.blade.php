...
<main>
    <div class="head-title">
        <div class="left">
            ...
            <ul class="breadcrumb">
                ...
                <li><a class="active" href="/">Criar Comentário</a></li>
            </ul>
        </div>
    </div>
    ...
    <div class="form-wrapper">
        <form action="/criarComentario" method="POST" class="styled-form">
...
<style>
    ...
    .form-group textarea {
        height: 100px; /* Altura maior para o campo de comentário */
    }

    .form-group input:focus, .form-group textarea:focus {
        outline: none;
        border-color: #57b8ff; /* Azul claro para o foco */
