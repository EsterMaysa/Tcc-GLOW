...
<main>
    ...
    <div class="form-wrapper">
        <form action="/criarNotificacaoEstoque" method="POST" class="styled-form">
            @csrf <!-- Token de segurança do Laravel -->

            <div class="form-group">
                <label for="idEstoque">Id Estoque</label>
                <input type="text" id="idEstoque" name="idEstoque" required>
            </div>

            <div class="form-group button-wrapper">
                <button type="submit" class="submit-btn">Criar Notificação Estoque</button>
            </div>
        </form>
    </div>
</main>
